...
def go(args):
    ...
    output_model_artifact = wandb.Artifact(name=args.output_artifact, type='model', description='trained random forest model', metadata=rf_config)
    output_model_artifact.add_dir('random_forest_dir/')
